...
//redirection code every time Auth changes
...
return () => unsubscribe();
    ...
    return (
        <div className={`${context!=="login" ? "flex justify-between" : ""} absolute z-[999] w-screen  py-2 bg-gradient-to-b from-black ${context==="login" ? "px-40" : "px-13"}`}>
